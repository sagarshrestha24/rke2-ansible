...
| analytics.environment.DB_HOST | string | `"postgresql-db.supabase.svc.cluster.local"` |  |
...
| analytics.environment.LOGFLARE_NODE_HOST | string | `"postgresql-db.supabase.svc.cluster.local"` |  |
...
| auth.environment.DB_HOST | string | `"postgresql-db.supabase.svc.cluster.local"` |  |
...
| functions.environment.DB_DRIVER | string | `"postgres"` |  |
| functions.environment.DB_HOST | string | `"postgresql-db.supabase.svc.cluster.local"` |  |
