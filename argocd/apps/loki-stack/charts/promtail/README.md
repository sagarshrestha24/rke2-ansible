...
| containerSecurityContext | object | `{"allowPrivilegeEscalation":true,"capabilities":{"drop":["ALL"]},"privileged":true,"readOnlyRootFilesystem":false}` | The security context for containers |
...
| rbac.pspEnabled | bool | `true` | Specifies whether a PodSecurityPolicy is to be created |
