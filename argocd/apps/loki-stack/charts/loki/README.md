...
| config.compactor.working_directory | string | `"/data/loki/compactor"` |  |
...
| config.limits_config.allow_structured_metadata | bool | `false` |  |
...
| config.schema_config.configs[0].from | string | `"2024-12-06"` |  |
...
| config.schema_config.configs[0].schema | string | `"v13"` |  |
