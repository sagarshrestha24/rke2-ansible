...
![Version: 16.3.2](https://img.shields.io/badge/Version-16.3.2-informational?style=flat-square) ![AppVersion: 17.2.0](https://img.shields.io/badge/AppVersion-17.2.0-informational?style=flat-square)
...
| image.tag | string | `"17.2.0-debian-12-r3"` |  |
| kubeVersion | string | `""` |  |
| ldap.basedn | string | `""` |  |
| ldap.binddn | string | `""` |  |
| ldap.bindpw | string | `""` |  |
...
| metrics.image.tag | string | `"0.16.0-debian-12-r2"` |  |
