...
```
git clone https://github.com/longhorn/csi-provisioner.git
cd csi-provisioner/
git checkout v5.1.0-20241220
```
...
```
docker build -t savannah.ornl.gov/kdi/coreii-data-lake/csi-provisioner:v4.8.1-12_19_24 .
docker push savannah.ornl.gov/kdi/coreii-data-lake/csi-provisioner:v4.8.1-12_19_24
```
...
```
trivy image savannah.ornl.gov/kdi/coreii-data-lake/csi-provisioner:v4.8.1-12_19_24
```
