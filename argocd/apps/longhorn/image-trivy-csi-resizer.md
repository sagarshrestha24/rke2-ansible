# Scanning and Resolving longhorn csi resizer Docker Image Vulnerabilities using Trivy
...
```
git clone https://github.com/longhorn/csi-resizer.git
cd csi-resizer
git checkout v1.12.0-20241219
```
...
```
docker build -t savannah.ornl.gov/kdi/coreii-data-lake/csi-resizer:v4.8.1-12_19_24 .
docker push savannah.ornl.gov/kdi/coreii-data-lake/csi-resizer:v4.8.1-12_19_24
```
...
```
trivy image savannah.ornl.gov/kdi/coreii-data-lake/csi-resizer:v4.8.1-12_19_24
```
