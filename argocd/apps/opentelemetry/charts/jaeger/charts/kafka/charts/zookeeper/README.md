...
![Version: 12.4.0](https://img.shields.io/badge/Version-12.4.0-informational?style=flat-square) ![AppVersion: 3.9.1](https://img.shields.io/badge/AppVersion-3.9.1-informational?style=flat-square)
...
| image.tag | string | `"3.9.1-debian-11-r2"` |  |
| initContainers | list | `[]` |  |
| initLimit | int | `10` |  |
| jvmFlags | string | `""` |  |
| kubeVersion | string | `""` |  |
