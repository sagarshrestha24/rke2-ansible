...
![Version: 26.6.2](https://img.shields.io/badge/Version-26.6.2-informational?style=flat-square) ![AppVersion: 3.6.1](https://img.shields.io/badge/AppVersion-3.6.1-informational?style=flat-square)
...
| broker.initContainerResources.limits | object | `{}` |  |
| broker.initContainerResources.requests | object | `{}` |  |
...
| broker.logPersistence.size | string | `"8Gi"` |  |
| broker.logPersistence.storageClass | string | `""` |  |
| broker.minId | int | `100` |  |
| broker.minReadySeconds | int | `0` |  |
...
| broker.persistence.size | string | `"8Gi"` |  |
...
| controller.initContainerResources.limits | object | `{}` |  |
| controller.initContainerResources.requests | object | `{}` |  |
...
| controller.persistence.size | string | `"8Gi"` |  |
...
| externalAccess.autoDiscovery.containerSecurityContext.allowPrivilegeEscalation | bool | `false` |  |
| externalAccess.autoDiscovery.containerSecurityContext.capabilities.drop[0] | string | `"ALL"` |  |
| externalAccess.autoDiscovery.containerSecurityContext.enabled | bool | `true` |  |
| externalAccess.autoDiscovery.containerSecurityContext.readOnlyRootFilesystem | bool | `true` |  |
| externalAccess.autoDiscovery.containerSecurityContext.runAsNonRoot | bool | `true` |  |
| externalAccess.autoDiscovery.containerSecurityContext.runAsUser | int | `1001` |  |
| externalAccess.autoDiscovery.containerSecurityContext.seccompProfile.type | string | `"RuntimeDefault"` |  |
...
| externalAccess.autoDiscovery.image.tag | string | `"1.29.0-debian-11-r0"` |  |
...
| metrics.jmx.image.tag | string | `"0.20.0-debian-11-r2"` |  |
...
| metrics.kafka.customLivenessProbe | object | `{}` |  |
| metrics.kafka.customReadinessProbe | object | `{}` |  |
| metrics.kafka.customStartupProbe | object | `{}` |  |
...
| metrics.kafka.image.tag | string | `"1.7.0-debian-11-r134"` |  |
| metrics.kafka.initContainers | list | `[]` |  |
| metrics.kafka.livenessProbe.enabled | bool | `true` |  |
| metrics.kafka.livenessProbe.failureThreshold | int | `3` |  |
| metrics.kafka.livenessProbe.initialDelaySeconds | int | `5` |  |
| metrics.kafka.livenessProbe.periodSeconds | int | `10` |  |
| metrics.kafka.livenessProbe.successThreshold | int | `1` |  |
| metrics.kafka.livenessProbe.timeoutSeconds | int | `1` |  |
...
| metrics.kafka.readinessProbe.enabled | bool | `true` |  |
| metrics.kafka.readinessProbe.failureThreshold | int | `3` |  |
| metrics.kafka.readinessProbe.initialDelaySeconds | int | `5` |  |
| metrics.kafka.readinessProbe.periodSeconds | int | `5` |  |
| metrics.kafka.readinessProbe.successThreshold | int | `1` |  |
| metrics.kafka.readinessProbe.timeoutSeconds | int | `1` |  |
...
| metrics.kafka.startupProbe.enabled | bool | `false` |  |
| metrics.kafka.startupProbe.failureThreshold | int | `3` |  |
| metrics.kafka.startupProbe.initialDelaySeconds | int | `5` |  |
| metrics.kafka.startupProbe.periodSeconds | int | `5` |  |
| metrics.kafka.startupProbe.successThreshold | int | `1` |  |
| metrics.kafka.startupProbe.timeoutSeconds | int | `1` |  |
...
| sasl.controller.clientId | string | `"controller_broker_client"` |  |
| sasl.controller.clientSecret | string | `""` |  |
...
| sasl.interbroker.clientId | string | `"inter_broker_client"` |  |
| sasl.interbroker.clientSecret | string | `""` |  |
| sasl.interbroker.password | string | `""` |  |
| sasl.interbroker.user | string | `"inter_broker_user"` |  |
| sasl.oauthbearer.expectedAudience | string | `""` |  |
| sasl.oauthbearer.jwksEndpointUrl | string | `""` |  |
| sasl.oauthbearer.subClaimName | string | `"sub"` |  |
| sasl.oauthbearer.tokenEndpointUrl | string | `""` |  |
